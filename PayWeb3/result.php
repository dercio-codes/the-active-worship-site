<?php
	...
	include_once('../store/lib/php/global.inc.php');
...
<html>
	<head>
		...
		<link rel="stylesheet" href="../store/lib/css/bootstrap.min.css">
		<link rel="stylesheet" href="../store/lib/css/core.css">
	</head>
	<body>
		<div class="container-fluid" style="min-width: 320px;">
			...
			<div style="background-color:#000; color:#fff; text-align: center; margin-bottom: 15px; padding: 4px;"><strong>Result</strong></div>
			<div class="container">
				<form role="form" class="form-horizontal text-left" action="query.php" method="post" name="query_paygate_form">
					...
					<div class="form-group">
						...
						<div class="col-sm-2 col-sm-offset-4">
							<a href="../music.php" class="btn btn-primary btn-block">Return to music</a>
						</div>
						<div class="col-sm-2">
							<a href="http://54.225.103.138/TACbackend/Ablaze/Ablaze Album 2017.zip" download="http://54.225.103.138/TACbackend/Ablaze/Ablaze Album 2017.zip" class="btn btn-success btn-block">Download File</a>
						</div>
					</div>
				</form>
			</div>
        </div>
		<script type="text/javascript" src="../store/lib/js/jquery-1.10.2.min.js"></script>
		<script type="text/javascript" src="../store/lib/js/bootstrap.min.js"></script>
	</body>
</html>