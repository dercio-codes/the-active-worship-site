        ...
        <div id = "tabs" style="background: transparent; ">
          <img src="C:\Users\Sckalk laptop\Desktop\Active worship\the-active-worship-site\black-and-gray-audio-mixer-3784221.jpg" style="height: 100%; width: 100%;">
           ...
           <div id="mySidenav" class="sidenav">
            ...
            <a class="delay-1s" href="shop.html">         STORE          </a>
 ...
 <?php endif; ?>
    ...
    <form id="fom" action='<?php echo $_SERVER['PHP_SELF'];?>' method="POST" >
        <div class="form-group">
            ...
            <input required type="text" class="form-control" placeholder="Add Name"
            name="name">
        </div>
        ...
        <div class="form-group">
            ...
            <input required type="email" name="email" placeholder="janedoe@example.com" class="form-control">
        </div>
        ...
        <div class="form-group">
            ...
            <textarea required id="txtarea" class="form-control" name="message" placeholder="Add Message"></textarea>
         </div>
